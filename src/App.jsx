...
// Gated on isAutoGenerated too (posts.is_auto_generated) — the automation
// posts to these same subcategories under the site's own "코리안에셋"
// account, which is also how the owner posts real hand-written articles,
// so subcategory alone isn't enough: it noindexed a real post once
// (2026-09-03) before this flag was added.
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const shouldNoindex = view.page === "detail" && currentPost?.isAutoGenerated && NOINDEX_SUBCATEGORIES.has(currentPost?.subcategory);
    if (shouldNoindex) {
      if (!meta) {
